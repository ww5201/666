...
本指南详细介绍如何将视频网站的后端系统部署到Netlify，实现完整的云端部署方案。
...
# 提交初始代码
git commit -m "Initial commit: Video website backend system"

# 添加远程仓库
git remote add origin https://github.com/ww5201/video-website-backend.git
...
4. 选择 `ww5201/video-website-backend` 仓库
5. 配置构建设置：
...
### 部署验证脚本
创建 `verify-netlify-deployment.bat`：
